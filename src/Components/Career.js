  ...
  <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleFade" data-bs-slide="next">
   ...
   <div class="container">
        <div class="section-title p-5">
            ...
            <p>
                We at CLC Institute strongly believes in quality and standards education. So we always keep on <br/> looking for subject experts in our field. If you find yourself perfect and want to join our Institute as a <br/> faculty member then send us a mail We will contact you if we will find your resume relevant.
            </p>
          </div>
       </div>
       ...
       <div class="container bg_color" >
                <form accept-charset="UTF-8">
                  <div class="form-group">
                    ...
                    <input type="text" name="fullname" class="form-control" id="exampleInputName" placeholder="Type your first name" required="required"/>
                  </div>
                  <div class="form-group">
                    <label for="InputName">First Name*</label>
                    <input type="text" name="fullname" class="form-control" id="exampleInputName" placeholder="Type your first name" required="required"/>
