...
<div class="container">
            <div class="row heading">
                <div class="section-title pt-5 ">
                    ...
                    <h2 class="mt-4">
                      <span  style={{fontWeight:'700'}}>GalleryPhoto</span>
                      Gallery
                    </h2>
                  </div>
                <div class="col-lg-3">
                    <div class=" card_two  text-white " style={{width:'100%'}}>
                        <img class="card-img-top" src={require("../Assets/image/HISAR.jpg")} alt="Card image" style={{width:'100%'}}/>
                        <div class="card-body-gallery ">
                          <h4 class="card-title">HISAR</h4>
                        </div>
                      </div>
                </div>
                <div class="col-lg-3">
                    <div class="card_two  text-white " style={{width:'100%'}}>
                        <img class="card-img-top" src={require("../Assets/image/SIRSA & FATEHABAD.jpg")} alt="Card image" style={{width:'100%'}}/>
                        <div class="card-body-gallery ">
                          <h4 class="card-title">SIRSA & FATEHABAD</h4>
                        </div>
                      </div>
                </div>
                <div class="col-lg-3">
                    <div class="card_two  text-white " style={{width:'100%'}}>
                        <img class="card-img-top" src={require("../Assets/image/jaipur.jpg")} alt="Card image" style={{width:'100%'}}/>
                        <div class="card-body-gallery ">
                          <h4 class="card-title">DTSE-JAIPUR</h4>
                        </div>
                      </div>
                </div>
                <div class="col-lg-3">
                    <div class="card_two  text-white " style={{width:'100%'}}>
                        <img class="card-img-top" src={require("../Assets/image/JHUNJHUNU.jpg")}alt="Card image" style={{width:'100%'}}/>
                        <div class="card-body-gallery ">
                          <h4 class="card-title">DTSE-JHUNJHUNU</h4>
                        </div>
                      </div>
                </div>
            </div>
