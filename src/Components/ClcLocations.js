...
<div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
  ...
  <div class="container-fluid mt-5 clc_locatioin_img">
          <div class="container">
            <div class="Head_office">
                <h2> CLC <span>Head Office</span></h2>
              <div class="skyBlue_line"></div>
            </div>
        </div>
      </div>

      <div class="container mt-4 clc_locatioin_img">
        <div class="row">
            <div class="col-lg-8">
                <img src={require("../Assets/image/contact-banner-1.jpg")} alt=""/>
            </div>
            <div class="col-lg-4 ">
                <div id="clc_head_office">
                    <h3 className='mb-4'>CLC Sikar</h3>
                <p><strong>कर्मस्थली, </strong><br/>
                    Pandit Harinath Chaturvedi Marg<br/>
                    Piprali Road,<br/>
                    Sikar, Rajasthan<br/>
                   <strong> Ph.<a href="#"> 01572-255500,<br/>
                    258500<br/></a>
                    Mob. <a href="#">94140-36555</a><br/>
                    Email Id. <a href="#"> info@clcparivar.in</a></strong></p>
            </div>
        </div>
        </div>
      </div>
      ...
      <div class="container mt-5 clc_locatioin_img">
        <div class="Head_office">
            <h2> CLC <span>Head Office</span></h2>
          <div class="skyBlue_line"></div>
        </div>
        <img src={require("../Assets/image/building.jpg")}  alt=""/>
    </div>

        <div class="container align_center mt-4 mb-3">
          <div class="row">
            <div class="col-lg border">
              <h3>ALWAR Study Center
              </h3>
              <p>संकल्पस्थली, Plot No. 966, Vijay Nagar, Near Rao Tularam Circle, Alwar<br/>Ph.: 0144-2730388 • Mob.: 99832-37886
              </p>
            </div>
            <div class="col-lg border">
              <h3>ALWAR Study Center
