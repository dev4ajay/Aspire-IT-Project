...
<div>
 ...
 <div className='container terms_mains'> 
  <h2>
  <span style={{fontWeight:'300'}}> Terms and</span> Conditions  
    <div class="skyblue"></div>
  
  </h2>
  
  <div class="com">
    <p><img src={require("../Assets/image/blab.jpeg")} className='blab_img'  style={{width: '40px' , height: '50px'}} alt=""/> 
CLC reserves the rights to deny any admission without giving any reason whatsoever it may be.
</p>
<div class="black"></div>
       <p><img src={require("../Assets/image/blab.jpeg")} className='blab_img'  style={{width: '40px' , height: '50px'}} alt="" />

Confirm your age, eligibility & domicile for next coming NEET/ JEE Exam. CLC will not be responsible for any matter regarding age, eligibility & domicile.
</p>
        <div class="black"></div>
       <p><img src={require("../Assets/image/blab.jpeg")} className='blab_img'  style={{width: '40px' , height: '50px'}} alt=""/> 

If original I-card is lost, duplicate I-card will be issued on depositing Rs. 100/- only for each.
</p>
        <div class="black"></div>
       <p><img src={require("../Assets/image/blab.jpeg")} className='blab_img'  style={{width: '40px' , height: '50px'}} alt=""/>

CLC reserves the right to make any change in working hours, time table etc. without any prior information.
        </p>
        <div class="black"></div>
       <p><img src={require("../Assets/image/blab.jpeg")} className='blab_img'  style={{width: '40px' , height: '50px'}} alt=""/>

If any information given by candidate is found incorrect or false, his/her admission will be cancelled without any refund.

</p>
<div class="black"></div>
       <p><img src={require("../Assets/image/blab.jpeg")} className='blab_img' style={{width: '40px' , height: '50px'}} alt=""/>

Use of mobile phone for a student in CLC campus is strictly prohibited. The student shall be imposed monetary punishment, debarment from class or termination.
</p>
<div class="refund">
  <div class="row">
  <h2><span style={{fontWeight:'300'}}> Refund</span> Rule<span  style={{fontWeight:'300'}}> (Only for Offline Classroom Courses)</span></h2>
...
<section className='main_terms'>
    <div class="container tablecollapse">
<ol type="1">
  <li>Refund of any amount if payable shall be refunded by cheque only after deducting the following amount + GST on it :-
<table cellspacing="0" cellpadding="0">
<tbody>
  <tr>
    <th>Upto 7 Days of admission deduction</th>
    <th class="Main">Rs. 6000 + GST</th>
  </tr>
  <tr>
    <th>Upto 21 Days of admission deduction</th>
    <th class="Main">Rs. 17000 + GST</th>
  </tr>
  <tr>
    <th>Upto 30 Days of admission deduction</th>
    <th class="Main">Rs. 22000 + GST</th>
  </tr>
  <tr>
    <th>Upto 30 Days of admission deduction</th>
    <th class="Main">Rs. 22000 + GST</th>
  ...
  <li> After 30 days of admission, there will be No Fee Refund.</li>
  <li> If the Course fee is refunded in that case only parents of ward will be eligible to take the amount and the amount will be paid through Cheque.</li>
  <li> After 30 days of admission, there will be No Fee Refund.</li>
  <li>To receive refundable amount, the parents of ward should apply in written.</li>
  <li>In special cases where any student gets admission in Govt. Medical/ IIT/NIT college may get a refund of 50% of the amount deposited deducting GST on it even after 30 days on producing the following documents.

    <ul>
      <li>(a)  Copy of college seat allotment letter.</li>
      <li>(b) Copy of fee receipt of college where admission taken.</li>
      <li>(c)  Original fee receipt of CLC.</li>
      <li>(d) Student I-card.</li>
    </ul>
  </li>
...
<li>These refund norms will be applicable till government not generate new refund policy.</li>
<br/><br/>
<div class="twitter">
<p><h6>Using Terms & Conditions :</h6></p>
  <li><h6>Using Personal information :</h6> We use your Personal Information to provide our services to you, which include: offering products for sale, processing payments, shipping and fulfilment of your order and keeping you up to date on new products, services, and offers.</li>
</div>
</div>
</ol>
</div>
