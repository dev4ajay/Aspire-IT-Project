...
<div class="content1">
        <div class="container">
          <div class="section-title-2 headline text-left">
            <h2>
              <span style={{fontWeight: '700'}}> JEE (Main & Advanced)</span>
          ...
          <div class="row">
            <div class="col-lg-3">
              <div class="section-title-2 headline text-left">
                <h2 class="mt-5 "> 
                  <strong style={{fontWeight: '700'}}> XI </strong>

                  Foundation
                </h2>
                <div class="blue-line"></div>
              </div>
              <div class="table_nav mt-5">
                <table cellspacing="0" cellpadding="0">
                  <tbody>
                    <tr>
                      <th style={{width: '30%'}}>Eligibility</th>
                      <td style={{width: '70%'}}>X Passed in 2023.</td>
                    </tr>
                    <tr>
                      <th style={{width: '30%'}}>Objective</th>
                      <td style={{width: '30% ' , background: '#f9f9f9'}} >
                        This course is for XI undergoing students preparing for
                        NEET.
                        <br />
                        Two years XI & XII Foundation Course for X passed
                        students who are willing to Crack NEET-2025. This course
                        curriculum is an early knock for NEET in which we offer
                        a balanced programme for board exam & Olympiads also. To
                        revise syllabus & practice through 70+ Test Papers
                        before NEET-2025.
                      </td>
                    </tr>
                    <tr>
                      <th style={{width: '30%'}}>Course Duration</th>
                      <td style={{width: '70%'}}>Two Year</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div class="col-lg-3">
              <div class="section-title-2 headline text-left">
                <h2 class="mt-5">
                  <strong style={{fontWeight: '700'}}> XII </strong>
                  Foundation
                </h2>
                <div class="blue-line"></div>
              </div>
            ...
            <div class="col-lg-3">
              <div class="section-title-2 headline text-left">
                <h2 class="mt-5">
                  <strong style={{fontWeight: '700'}}> 2 in 1 </strong>
                  Course
                </h2>
              ...
              <div class="table_nav mt-5">
                <table cellspacing="0" cellpadding="0">
                  <tbody>
                    ...
                    <tr>
                      <th style={{width: '30%'}}>Objective</th>
                      <td style={{width: '70%'  ,background: '#f9f9f9'}}>
                        This course is for XI undergoing students preparing for
                        NEET.
                        <br />
                        Two years XI & XII Foundation Course for X passed
            ...
            <div class="col-lg-3">
              <div class="section-title-2 headline text-left">
                <h2 class="mt-5">
                  <strong style={{fontWeight: '700'}}> Target </strong>
                  Course
                </h2>
                <div class="blue-line"></div>
              </div>
                ...
                <div class="table_nav mt-5">
                  <table cellspacing="0" cellpadding="0">
                    <tbody>
                      <tr>
                        <th>Medium</th>
                        <td>Medium of instruction English & Hindi</td>
                      </tr>
                      <tr>
                        <th>Admission</th>
                      ...
                      <tr>
                        <th>School Admission</th>
                        <td>At CLC’s own school CBSE & RBSE Board.</td>
                      </tr>
                      <tr>
                        <th>Test Paper</th>
                        <td>Test paper in both language.</td>
                      </tr>
                      <tr>
                        <th>Study Material</th>
                        <td>
                          Study material as per the medium (English or Hindi )
                          of student. Unit wise Notes will be provided to
                          students as per their course.
                        </td>
                      </tr>
                      <tr>
                        <th>Vacation:</th>
                        <td>7 Days for Deepawali & 2 Days for Holi</td>
                      </tr>
                      <tr>
                        <th>Medium</th>
                        <td>Medium of instruction English & Hindi</td>
                      ...
                      <tr>
                        <th>Fee & Scholarship</th>
                        <td>
                          Refer
                          <a class="link"
                            href="https://www.clcparivar.in/fees/"
                            target="_blank"
                            >Fee Chart</a>
                          
                          &
                          <a class="link"
                            href="https://www.clcparivar.in/scholarship/"
                            target="_blank"
                            >Scholarship </a>
