...
<div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleFade" data-bs-slide="next">
    ...
    <div class="container-fluid mt-5">
      ...
      <div class="container form_center mt-3 col-md-6 offset-md-3">
        <form action="/action_page.php" >
          ...
          <div class="mb-3 mt-3">
            <input id="phone" type="tel" class="form-control" name="phone"   placeholder='Enter Mobile Number'/>
            </div>
          ...
          <div class="row">
            ...
            <div class="col">
              <input type="text" class="form-select" placeholder="Select City *" name="text" disabled/>
            </div>
          </div>
        </div>
          ...
          <div class="mb-3">
            <select id="country" name="country" class="form-select">
                <option value="australia" >Course *</option>
                <option value="canada">NEET </option>
                <option value="usa">JEE</option>
                <option value="usa">Pre-Foundation</option>
                <option value="usa">NDA</option>
                <option value="usa">Online Classes</option>
                <option value="usa">Test Series</option>
          ...
          <div class="mb-3 mt-3">
            <div class="row">
              <div class="col">
                <input type="text" class="form-control" placeholder="Enter Captcha *" name="text"/>
              </div>
              <div class="col">
                <input type="text" class="form-control" placeholder="Enter text as Shown *" name="text"/>
              </div>
            </div>
          </div>
