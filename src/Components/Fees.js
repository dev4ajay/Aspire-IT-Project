...
<div>
 ...
 <div class="fee">
  <br/>
    <div class="title">
    <h2 class="mt-4">
      FEE - $ 1,05,000 (Including GST)
    </h2>

<p>NEET • JEE (TARGET • XI & XII Foundation • 2 in 1 Batch)</p>
      <h3>Scholarship for Classroom Programme : 2023-24</h3>
    </div>
...
<div className='container'>
<div class="para">
  <li>Early Bird Admission : 5000/- Additional off if registered & deposited Fee by 8 March 2023</li>
  <li>Defence Personnels Scholarship Rs. 8000/- To the wards of Defence & Police Personnels This is an additional Scholarship.</li>


  <h2 class="mt-5">ADDITIONAL SCHOLARSHIP</h2>
  <p>STUDENT CAN OPT ANYONE OF THESE SCHOLARSHIP.</p>



  <li>CLC’s own students of Foundation Course or student of CLC’s own school for One year is taking admission in Target / XI Foundation Course will get Rs. 5,000 & for Two or more years will get Rs. 10,000 additional scholarship.</li>
  <li>Rs. 10000/- additional off on payable amount after X/XII Board percentage scholarship will be given to siblings (Real brother / sister) of selected CLCian in IITs, NITs & Govt. Medical Colleges.</li>
  <li>Rs. 3000/- additional off on payable amount after X/XII Board percentage scholarship will be given to ward of Gaurav Parivar (Brother / sister of selected CLCian in IITs, NITs & Govt. Medical Colleges.)</li>
  <li>Brother/sister of Ex. CLCians will get Rs. 2000 additional scholarship.</li>
<li>Two or more students from same family will get Rs. 3000 additional scholarship. (Each student)</li>

  <h3 class="mt-5">Documents Required for Scholarship (along with application form)</h3>
  
  <li>Original Marksheet of 10th / 12th.</li>
  <li>Original Aadhar Card along with 1copy of xerox.</li>
  <li> Proof of being CLC’s old student.</li>
  <li>  Proof of selected CLCian’s sibling to availing Special Scholarship .</li>
  </div>
...
<div className='container'>
  <div class="para1 ">
  <h2 style={{fontWeight: 'bold'}} class="mt-5">FEE for PRE-FOUNDATION</h2>
  <li>Early Bird Admission : 5000/- Additional off if registered & deposited Fee by 8 March 2023</li>
  <li>Defence Personnels Scholarship Rs. 4000/- To the wards of Defence & Police Personnels This is an additional Scholarship.</li>
  ...
  <h6>Registration Charge RS. 5000/ (Including GST) Excluding Coaching Fee. (Non Refundable)
