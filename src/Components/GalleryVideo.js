    ...
    <span class="visually-hidden">Next</span>
           ...
           <div class="container">
            <div class="row heading">
                ...
                <div class="col-lg-4">
                    <iframe width="360" height="215" src="https://www.youtube.com/embed/KewpGLmX9Sk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                </div>
                <div class="col-lg-4">
                    <iframe width="360" height="215" src="https://www.youtube.com/embed/KewpGLmX9Sk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                </div>
        ...
        <div class="row justify-content-center mt-5">
            <div class="col-lg-4 button">
                <div class="more-photo ">
                    <a href="https://www.flickr.com/photos/clcsikar/albums" target="_blank">VIEW VIDEO GALLERY</a>
                </div> 
            </div>
            </div>
        </div>
