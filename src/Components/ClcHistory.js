...
<div class="container my-5">
        <h3>CLC History</h3>
        <div class="skyBlue_line mb-5"></div>

      

        <div class="clc-histroy-box">
            <div class="heading">
                <h2>1996</h2>
            </div>
            <div class="desc">
                <p>With the objective of “CLC ka sapana har gaon se Doctor/Engineer bane apana.” CLC was started with 10 students. </p>
            </div>
        </div>
